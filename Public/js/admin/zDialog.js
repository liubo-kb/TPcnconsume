 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = '../../Public/image/'; //图片路径配置
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td height="60" style="background-color: #0082cf;"><div style="padding-left:10px; float: left; font-weight: bold; color:#fff; font-size:14px; height:40px; line-height:40px;"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);"  style="cursor: pointer; float: right; width: 25px; color:#fff; font-size:24px; height:40px;">×</div></td>\
    </tr>\
    <tr valign="top">\
	...
	' + (function (obj) {
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="60"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 0 20px; height:60px; line-height:60px; text-align: right; background-color:#f6f6f6;">\
                <input type="button" class="confirmBtnStyle" value="确 定" id="_ButtonOK_' + this.ID + '"/>\
                <input type="button" class="concelBtnStyle" value="取 消" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
    </tr>\
...
Dialog.getBgdiv = function () {
	var winnerhei = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight;
    if (Dialog.bgDiv) return Dialog.bgDiv;
    var bgdiv = topWin.$id("_DialogBGDiv");
    if (!bgdiv) {
        bgdiv = topDoc.createElement("div");
        bgdiv.id = "_DialogBGDiv";
        bgdiv.style.cssText = "position:absolute;left:0px;top:0px;width:100%;height:"+winnerhei+"px;z-index:900;background-color:#333;opacity:0.4;filter:alpha(opacity=40);";
//      var bgIframeBox = '<div style="position:relative;width:100%;height:100%;">';
        
//		var bgIframeMask = '<div id="_DialogBGMask" style="position:absolute;width:100%;height:'+winnerhei+'px;"></div>';
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><img id="Icon_' + this.ID + '" src="data:image/png;base64," width="34" height="34" align="absmiddle">&nbsp;&nbsp;</td>\

var app=angular.module('ionicApp', ['ionic','app.controllers','app.services','app.directives','app.filters','ngIOS9UIWebViewPatch','ls.bmap','CoderYuan'])
      ...
      $stateProvider
       ...
       .state('merQuan',{
        ...
        .state('cengInfo', {
      	...
      	.state('system',{
      		url:"/system",
      		cache:false,
      		templateUrl:"templates/myshow/user/system.html",
      	...
      	.state('author',{
      		url:"/author",
      		cache:false,
      		templateUrl:"templates/myshow/user/author.html",
      	...
      	.state('getCheck',{
      		...
      		cache:false,
      		 params:{id:""},
      		templateUrl:"templates/myshow/user/getCheck.html",
      		controller:'getCheckCtrl'
      	})
		...
		//修改性别、婚姻、教育
      	...
      	.state('lover',{
      		url:"/lover",
      		cache:false,
      		templateUrl:"templates/myshow/user/lover.html",
      		controller:'loverCtrl'
      	})
       ...
       //我的会员卡
        ...
        .state('shareClass',{
          ...
          cache:false,
          params:{id:""},
          templateUrl: "templates/myshow/huiyuanka/cardInfo/shareClass.html",
          controller:"shareClassCtrl"
        })
        ...
        //储值卡支付
       	.state('value',{
       		...
       		cache:false,
       		params:{id:""},
       		templateUrl:"templates/myshow/huiyuanka/cardPay/value/index.html",
       	...
       	.state('cardPayPass',{
       		...
       		cache:false,
       		params:{id:"",type:""},
       		templateUrl:"templates/myshow/huiyuanka/cardPay/value/cardPayPass.html",
       	...
       	.state('count',{
       		...
       		cache:false,
       		params:{id:""},
       		templateUrl:"templates/myshow/huiyuanka/cardPay/count/index.html",
       	...
       	.state('cardCountPass',{
       		...
       		cache:false,
       		params:{id:"",type:""},
       		templateUrl:"templates/myshow/huiyuanka/cardPay/count/cardCountPass.html",
       	...
       	.state('meal',{
       		...
       		cache:false,
       		params:{id:""},
       		templateUrl:"templates/myshow/huiyuanka/cardPay/meal/index.html",
       		controller:"mealCtrl"
       	})
       	...
       	.state('cardPackagePass',{
       		...
       		cache:false,
       		params:{id:"",type:""},
       		templateUrl:"templates/myshow/huiyuanka/cardPay/meal/cardPackagePass.html",
       	...
       	.state('experience',{
       		...
       		cache:false,
       		params:{id:""},
       		templateUrl:"templates/myshow/huiyuanka/cardPay/experience/index.html",
       	...
       	.state('cardExperPass',{
       		...
       		cache:false,
       		params:{id:""},
       		templateUrl:"templates/myshow/huiyuanka/cardPay/experience/cardExperPass.html",
       ...
       .state('recard',{
       	...
       	.state('payXu',{
       		 ...
       		 cache:false,
          	 params:{id:""},
       		 templateUrl: "templates/myshow/huiyuanka/renewal/payXu.html",
       		 controller:'payXuCtrl'
       	})
		...
		//我要升级
       	.state('upter',{
       		...
       		params:{id:""},
       		cache:false,
       		templateUrl: "templates/myshow/huiyuanka/upter/index.html",
       		controller:"upterCtrl"
       	})

       	//我要升级-支付
       	.state('payUpter',{
       		 url:'/payUpter/?:id/?:type/?:sum',
       		 cache:false,
          	 params:{id:"",type:"",sum:""},
       		 templateUrl: "templates/myshow/huiyuanka/upgrade/payUpter.html",
       		 controller:'payUpterCtrl'
       	})
       ...
       //我要预约
       	.state('order',{
       		...
       		cache:false,
       		params:{id:""},
       		templateUrl: "templates/myshow/huiyuanka/order/index.html",
       ...
       .state('bespeak',{
       		url:'/bespeak/:mid/:uid',
       		cache:false,
       		templateUrl: "templates/myshow/huiyuanka/order/bespeak.html",
       ...
       //家庭共享
       	.state('family',{
       		...
       		cache:false,
       		params:{id:""},
       		templateUrl: "templates/myshow/huiyuanka/family/index.html",
    ...
    //我的钱包-提现-输入密码
	   .state('depPass',{
	   		...
	   		cache:false,
	   		params:{id:"",type:""},
	   		templateUrl:"templates/myshow/myBao/depPass.html",
	   		controller:"depPassCtrl"
	   })
    
     //我的钱包-提现状态
       .state('depState',{
       		url:"/depState/?:id/?:type/?:sum",
       		cache:false,
            params:{id:"",type:"",sum:""},
       		templateUrl:"templates/myshow/myBao/depState.html",
       		controller:"depStateCtrl"
       })
    ...
    //我的优惠券 - 商消乐优惠券
     ...
     //我的消费 - 评价消费
	 	.state('grade',{
	   		...
	   		cache:false,
	   		params:{id:""},
	   		templateUrl:"templates/myshow/myShop/grade.html",

...
<ul class="dowebok">
	...
	<?php if(is_array($reason)): $i = 0; $__LIST__ = $reason;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$reason): $mod = ($i % 2 );++$i;?><li><input type="checkbox" name="checkbox" value="<?php echo ($reason); ?>" data-labelauty="<?php echo ($reason); ?>"></li><?php endforeach; endif; else: echo "" ;endif; ?>

    ...
    <div class="con">
        ...
        <div class="cmain">
            ...
            <div class="cinfo" id="content" style="margin-top: 20px;">
            	<table class="ctable tbinfo">
						<?php if(is_array($index)): $i = 0; $__LIST__ = $index;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$index): $mod = ($i % 2 );++$i;?><tr class='alt'>
								<td>
									<span style='text-size:60px;font-weight:bold;'><?php echo ($text["$index"]); ?></span>
									:
									<span style='text-size:20px'><?php echo ($result["$index"]); ?></span>
								</td>

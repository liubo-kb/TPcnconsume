...
<div class="container clearfix">
    ...
    <!--        页面内容        -->     
    <div class="con">
    	<p class="navinfo"><img src="/cnconsum/Public/image/merchant/isjbb.png" />&nbsp;&nbsp;升级记录</p>
        <div class="cmain">
        	<div class="cinfo1">
        		<p class="ftdt">
		            <select name="time" id="date_select" onchange="dateChange('data_sj')">
            ...
            <div class="cinfo" id="content" style="margin-top: 20px;">
				<table class ='ctable'>
					...
					<?php if(is_array($table_data)): $i = 0; $__LIST__ = $table_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><a class='abtn' href="data_detail?table=sj&user=<?php echo ($data["user"]); ?>&merchant=<?php echo ($data["merchant"]); ?>&datetime=<?php echo ($data["datetime"]); ?>">详细信息</a></td>

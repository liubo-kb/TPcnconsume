...
<div class="container clearfix">
	...
	<div class="con">
    	<div class="navinfo"><img src="/cnconsum/Public/image/merchant/info.png" />&nbsp;&nbsp;会员卡管理</div>
    	<div class="cmain">
    		<div class="cinfo" style="margin-top: 20px;">
    			<a href="turnURL?url=../card/addView" class="abtn-op ftd">添加会员卡</a>&nbsp;&nbsp;
    		</div>
            <div class="cinfo" id="content" style="margin-top: 20px;">
                 ...
                 <table class ='ctable'>
                        ...
                        <?php if(is_array($table_data)): $i = 0; $__LIST__ = $table_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a class='abtn' href="turnURL?url=../card/showView">查看</a></td>

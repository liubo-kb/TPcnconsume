...
<script src="/cnconsum/Public/js/merchant/zDrag.js" type="text/javascript"></script>
...
<script src="/cnconsum/Public/js/merchant/dialog.js" type="text/javascript"></script>
...
<div class="container clearfix">
    ...
    <div class="con">
        ...
        <div class="cmain">
        	<div class="cinfo" style="margin-top: 20px;">
    			<a href="adminAdd" class="abtn-op ftd">添加管理员</a>&nbsp;&nbsp;
    		</div>
            ...
            <div class="cinfo" id="content" style="margin-top: 20px;">
				<table class ='ctable'>
                        ...
                        <?php if(is_array($table_data)): $i = 0; $__LIST__ = $table_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a class='abtn' href="adminMod?account=<?php echo ($data["account"]); ?>">修改</a></td>
                                <td><a class='abtn' href="javascript:del('确定要删除这条信息吗？',<?php echo ($data["account"]); ?>)">删除</a></td>

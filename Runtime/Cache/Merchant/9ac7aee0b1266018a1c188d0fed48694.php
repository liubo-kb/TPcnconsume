...
<!--	资源文件	-->
<link rel="stylesheet" href="/cnconsum/Public/css/merchant/global.css">
<link rel="stylesheet" href="/cnconsum/Public/css/merchant/member_01.css">
...
<div class="container clearfix">
    ...
    <div class="zh"><img src="/cnconsum/Public/image/merchant/hy.png" id="ihy"/>&nbsp;&nbsp;我的会员</div>
    	...
    	<table class ='cable'>
				...
				<?php if(is_array($table_data)): $i = 0; $__LIST__ = $table_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
						<?php if(is_array($data_index)): $i = 0; $__LIST__ = $data_index;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$index): $mod = ($i % 2 );++$i;?><td>
								<?php if($index == 'headimage' ): ?><img style="width:55px;height:55px;margin:8px" src='/cnconsum/Public/Uploads/headImage/<?php echo ($data["$index"]); ?>'/>
								<?php else: ?>
									<?php echo ($data["$index"]); endif; ?>
							</td><?php endforeach; endif; else: echo "" ;endif; ?>
						<td><a class='abt' href="#">联系用户</a></td>

        ...
        <div class="cmain">
        	<div class="cinfo" id="content">
        		<?php if(is_array($table_data)): $i = 0; $__LIST__ = $table_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><table class="tb-blend">
					  <tr>
						<td class="td-pic" width="15%">
							<img src="/cnconsum/Public/Uploads/addImage/<?php echo ($data["image_url"]); ?>" class="img-shop" /><br>
						</td>
						<td align="left"><?php echo ($data["store"]); ?><br>申请管理您的店铺</td>
						<td width="15%" style="line-height: 30px;">
							<a href="../store/set?merchant=<?php echo ($data["muid"]); ?>&state=access" class="abtn-h">同意申请</a><br>
							<a href="../store/set?merchant=<?php echo ($data["muid"]); ?>&state=fail" class="abtn-j">拒绝申请</a>
						</td>
					  </tr>

...
<div class="content btp">
	...
	<div class="sucsbar">
		...
		<hr class="linex" />
		<a href="../register/info_01?phone=<?php echo ($account); ?>" class="abtn-lg">预付保险认证</a>
		<div class="ftip">
			<div>尊敬的用户，您已成功注册商消乐，体验功能，请<a href="../register/info_quick?phone=<?php echo ($account); ?>" class="maincolor">快速认证</a>！</div>
			<label>温馨提示：</label>
			<p>完成认证后，我们会在3-5个工作日审核完毕，请耐心等待！</p>
		</div>
	</div>
</div>
<!--footer start-->

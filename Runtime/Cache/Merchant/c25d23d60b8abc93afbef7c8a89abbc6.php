...
<div class="container clearfix">
    ...
    <div class="con">
    	<div class="navinfo"><img src="/cnconsum/Public/image/merchant/qrcode.png" style="width:30px;height:30px" id="ihy"/>&nbsp;&nbsp;收款码</div>
		
    	<div style="height: 240px; text-align:center;padding-top:50px">
			<img src="<?php echo ($qrcode); ?>" id="view" />		
    	</div>
    </div>	
</div>
<!--    页面尾部        -->

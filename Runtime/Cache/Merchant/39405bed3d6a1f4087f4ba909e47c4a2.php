...
<div class="content btp">
	...
	<div class="stepbar">
		...
		<label><img src="/cnconsum/Public/image/merchant/step-h.png" /></label>
	</div>
	
	<div class="sucsbar">
		<div class="box-sucs">
			<img src="/cnconsum/Public/image/merchant/success.png" />
			<p><b>资料提交完成</b><br>欢迎加入商消乐，祝您使用愉快！</p>
		</div>
		<div class="ftip">
			<label>温馨提示：</label>
			<p>您的店主信息和店铺信息已输入完成，我们会在3-5个工作日审核完毕，请耐心等待！</p>
		</div>
	</div>
</div>
<!--footer start-->

...
function subform(){
	...
	var url = 'add';
	var subdata = {code:code,name:name,remain:remain,price:price};
	formcheck(url, subdata, 'form-good');
}
</script>
<link rel="stylesheet" href="/cnconsum/Public/css/merchant/public.css" />
<div class="container clearfix">
    ...
    <div class="con">
    	<div class="navinfo"><img src="/cnconsum/Public/image/merchant/ihy.png" id="ihy"/>&nbsp;&nbsp;我的商品</div>
	    	<div class="frame">
		    		<form action="<?php echo ($action); ?>" method="post" id="form-good">
		    			<div>
		    			<span class="bj"><?php echo ($tip); ?></span>
		    			</div>
		    			
		    			<div>
		    				<span class="sb">商品编号：</span>
		    				<input  class="bh" type="text" name="code" value="<?php echo ($data["code"]); ?>"/>
						<input  class="bh" type="text" name="old_code" value="<?php echo ($data["code"]); ?>" style="display:none"/>
		    			</div>
		    			
		    			<div>
		    				<span class="uname">商品名称：</span>
		    				<input class="bn" type="text"  name="name" value="<?php echo ($data["name"]); ?>"/>
		    			</div>
		    			
		    			<div>
		    				<span class="ck">商品库存：</span>
		    				<input class="bh" type="text" name="remain" value="<?php echo ($data["remain"]); ?>"/>
		    			</div>
		    			
		    			<div>
		    				<span class="price">价格：</span>
		    				<input class="jg" type="text" name="price" value="<?php echo ($data["price"]); ?>"/>
		    			</div>
		    			
		    			<div class="submenu">
		    				<button class="next_text" id="J_register" type="button" id="submit" onclick="subform()">
				            	<a class="zd">确定</a>
				            </button>
				            <button class="next_text" id="cancel">
				            	<a href="commodity" class="qx">取消</a>
				            </button>	    				
		    			</div>

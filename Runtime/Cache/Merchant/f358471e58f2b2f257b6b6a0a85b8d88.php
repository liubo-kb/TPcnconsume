...
<link rel="stylesheet" href="/cnconsum/Public/css/merchant/jquery.range.css">
<script src="/cnconsum/Public/js/merchant/jquery.range.js"></script>
<script>
$(function(){
...
<div class="container clearfix">
    ...
    <div class="con">
    	<p class="navinfo"><img src="/cnconsum/Public/image/merchant/sxed.png" />&nbsp;&nbsp;授信额度</p>
        <div class="cmain">
            <div class="cinfo1">
            	<form action="" method="post" id="form-sxed">
            	<div class="tr-mbt">
            		<img src="/cnconsum/Public/image/merchant/isxed.png" class="img-sxed" />&nbsp;<span class="ftd">授信额度：</span>&nbsp;&nbsp;
            		<span class="fnum">10000.00</span>&nbsp;元
            	</div>
            	<div class="tr-mbt">
            		<img src="/cnconsum/Public/image/merchant/isyed.png" class="img-sxed" />&nbsp; <span class="ftd">剩余额度：</span>&nbsp;&nbsp;
            		<span class="fnum">2658.00</span>&nbsp;元
            	</div>
            	<div style="margin-top: 30px; height: 70px;">
            		<label><img src="/cnconsum/Public/image/merchant/iwyte.png" class="img-sxed" />&nbsp; <span class="ftd">我要提额：</span></label>
            		<div class="slidbox">
                		<input type="hidden" name="getmoney" id="getmoney" class="single-slider" value="5000" />
                	</div>
            	</div>
            	<div class="tr-mbt mgor">
            		<div class="tipbar">
            			<label>温馨提示：</label>
            			<p>
            				1.xxxxxxxxxxxxxxxxxxxxxxxx<br />
            				2.xxxxxxxxxxxxxxxxxxxxxxxx<br />
            				3.xxxxxxxxxxxxxxxxxxxxxxxx<br />
            			</p>
            		</div>
            	</div>
            	<div class="tr-mbt mgsub">
            		<input type="submit" value="提交申请" class="btn-ilg" />
            	</div>
                </form>
            </div>
        </div>

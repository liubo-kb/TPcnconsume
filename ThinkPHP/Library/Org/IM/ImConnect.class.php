...
//------------------------------------------------------用户体系	
	...
	public function __construct($options) {
		$this->client_id = isset ( $options ['client_id'] ) ? $options ['client_id'] : 'YXA6QkYGIB5uEeaGEXmL5YA9_A';
		$this->client_secret = isset ( $options ['client_secret'] ) ? $options ['client_secret'] : 'YXA6q6YEt0TvPZ6AKJpNbJt-nAbUxqs';
		$this->org_name = isset ( $options ['org_name'] ) ? $options ['org_name'] : 'kb0824';
		$this->app_name = isset ( $options ['app_name'] ) ? $options ['app_name'] : 'vipcard';
